 ...
 * Class PayoutRequest
 *
 * Uses payoutType group + additional payoutType enum field.
 * registrationKey is an XOR choice: set either masterPaymentNumber or tokenData — not both.
 */
class PayoutRequest implements PaymentRequestInterface, SignedInterface
{
    use RequestTrait;
