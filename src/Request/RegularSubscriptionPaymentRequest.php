...
/**
 * Class RegularSubscriptionPaymentRequest
 *
 * Uses recPaymentType2 group from WSDL.
 */
class RegularSubscriptionPaymentRequest implements PaymentRequestInterface, SignedInterface
{
    use RequestTrait;
