...
use Pronnect\GpWebPay\Request\PaymentDeleteRequest;
use Pronnect\GpWebPayApi\DigestInterface;

/**
 * @covers \Pronnect\GpWebPay\Request\PaymentDeleteRequest
 */
class PaymentDeleteRequestTest extends TestCase
{
    public function testGetDigestWithAllFields(): void
    {
        $request = new PaymentDeleteRequest();
    ...
    {
        $this->assertNull((new PaymentDeleteRequest())->getDigest());
    }
}
