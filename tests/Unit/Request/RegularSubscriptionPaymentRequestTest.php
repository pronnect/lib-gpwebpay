...
use Pronnect\GpWebPay\Request\RegularSubscriptionPaymentRequest;
use Pronnect\GpWebPay\Request\ShoppingCartInfo;
use Pronnect\GpWebPay\Request\SubMerchantData;
use Pronnect\GpWebPayApi\DigestInterface;

/**
 * @covers \Pronnect\GpWebPay\Request\RegularSubscriptionPaymentRequest
 */
class RegularSubscriptionPaymentRequestTest extends TestCase
{
    public function testSetAndGetFields(): void
    {
        $request = new RegularSubscriptionPaymentRequest();
        ...
        $this->assertSame(1200, $request->getSubscriptionAmount());
    ...
    {
        $this->assertNull((new RegularSubscriptionPaymentRequest())->getDigest());
    }
