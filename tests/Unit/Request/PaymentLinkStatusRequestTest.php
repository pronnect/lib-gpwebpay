...
use Pronnect\GpWebPay\Request\PaymentLinkStatusRequest;
use Pronnect\GpWebPayApi\DigestInterface;
use ReflectionClass;

/**
 * Class PaymentLinkStatusRequestTest
 * @covers \Pronnect\GpWebPay\Request\PaymentLinkStatusRequest
 */
class PaymentLinkStatusRequestTest extends TestCase
{
    public function testSetAndGetData(): void
    {
        $request = new PaymentLinkStatusRequest();
