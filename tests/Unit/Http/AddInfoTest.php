...
class AddInfoTest extends TestCase
{
    ...
    public function testToXmlWrapsInAdditionalInfoRequestVersion5(): void
    {
        ...
        $this->assertStringStartsWith('<additionalInfoRequest version="5.0">', $xml);
    ...
    public function testToXmlWithNoFieldsIsValid(): void
    {
        ...
        $this->assertSame('<additionalInfoRequest version="5.0"></additionalInfoRequest>', $xml);
    }
    ...
    public function testShoppingCartWithSingleItem(): void
    {
        ...
        $this->assertStringContainsString('<itemPrice>19900</itemPrice>', $xml);
    }
    ...
    public function testShippingDetailsIncludedInCardholderInfo(): void
    {
        ...
        $this->assertStringContainsString('<zip>81101</zip>', $xml);
    }
    ...
    public function testShippingDetailsAllFields(): void
    {
        $xml = (new ShippingDetails())
            ...
            ->setZip('04001')
            ->setState('KE')
            ->setDeliveryEmail('doprava@example.sk')
            ->setDeliveryTimeframe('04')
            ->setFirstUseDate('20240101')
            ->setShippingNameIndicator('01')
            ->toXml();
        ...
        $this->assertStringContainsString('<state>KE</state>', $xml);
        $this->assertStringContainsString('<deliveryEmail>doprava@example.sk</deliveryEmail>', $xml);
        $this->assertStringContainsString('<deliveryTimeframe>04</deliveryTimeframe>', $xml);
        $this->assertStringContainsString('<firstUseDate>20240101</firstUseDate>', $xml);
        $this->assertStringContainsString('<shippingNameIndicator>01</shippingNameIndicator>', $xml);
    }
    ...
    public function testBillingDetailsAllFields(): void
    {
        ...
        $this->assertStringContainsString('<state>Prague</state>', $xml);
    }
