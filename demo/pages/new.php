...
<div class="card">
  <div class="card-header">Apple Pay Order <span style="font-size:.72rem;font-weight:normal;color:#6b7280">— HTTP API, PAYMETHOD=APAY</span></div>
  <div class="card-body">
    <p style="font-size:.83rem;color:#475569;margin-bottom:.75rem">
      Redirect-based order locked to Apple Pay. <code>PAYMETHOD</code> and <code>PAYMETHODS</code> are set to <code>APAY</code> automatically.
    </p>
    <form method="post">
      <input type="hidden" name="action" value="create_apple_pay_order">
      <div class="row3">
        <div class="field">
          <label>Order number</label>
          <input type="number" name="order_number" value="<?= date('YmdHis') ?>" required min="1">
      ...
      <div class="hint" style="margin-bottom:.6rem">Return URL: <code><?= esc($_SESSION['cfg']['return_url'] ?? 'http://localhost:8080/return') ?></code></div>
      <button type="submit" class="btn btn-success"> Apple Pay → GP Webpay</button>
    </form>
  </div>
</div>

<div class="card">
  <div class="card-header">Google Pay Order <span style="font-size:.72rem;font-weight:normal;color:#6b7280">— HTTP API, PAYMETHOD=GPAY</span></div>
  <div class="card-body">
    <p style="font-size:.83rem;color:#475569;margin-bottom:.75rem">
      Redirect-based order locked to Google Pay. <code>PAYMETHOD</code> and <code>PAYMETHODS</code> are set to <code>GPAY</code> automatically.
    </p>
    <form method="post">
      <input type="hidden" name="action" value="create_google_pay_order">
      <div class="row3">
        <div class="field">
          <label>Order number</label>
          <input type="number" name="order_number" value="<?= date('YmdHis') ?>" required min="1">
      ...
      <div class="hint" style="margin-bottom:.6rem">Return URL: <code><?= esc($_SESSION['cfg']['return_url'] ?? 'http://localhost:8080/return') ?></code></div>
      <button type="submit" class="btn btn-success">G Google Pay → GP Webpay</button>
    </form>
  </div>
</div>
